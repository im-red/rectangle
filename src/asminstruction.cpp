...
bool is0OpInstr(unsigned char value) {
  static const set<unsigned char> s_instr0 = {
      IADD,     ISUB,        IMUL,        IDIV,       IREM,        IEQ,
      INE,      ILT,         IGT,         ILE,        IGE,         INEG,
      IAND,     IOR,         INOT,        FADD,       FSUB,        FMUL,
      FDIV,     FEQ,         FNE,         FLT,        FGT,         FLE,
      FGE,      FNEG,        SADD,        SEQ,        SNE,         POP,
      VECTOR,   VAPPEND,     VLOAD,       VSTORE,     RET,         LEN,
      PRINT,    HALT,        DEFINESCENE, PUSHORIGIN, POPORIGIN,   DRAWRECT,
      DRAWTEXT, DRAWELLIPSE, DRAWPOLYGON, DRAWLINE,   DRAWPOLYLINE};
...
bool is1OpInstr(unsigned char value) {
  static const set<unsigned char> s_instr1 = {
      GLOAD,  GSTORE, LLOAD,  LSTORE, FLOAD, FSTORE, ICONST,
      FCONST, SCONST, STRUCT, BR,     BRT,   BRF,    CALL,
  };
