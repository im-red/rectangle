...
string BindingDecl::bindingId() const {
  ...
  return componentInstance->instanceId + "[" +
         to_string(propertyDecl->fieldIndex) + "]";
}
...
string UnaryOperatorExpr::typeString(UnaryOperatorExpr::Op type) {
  static const map<Op, string> MAP = {ENUM_ELEMENT(Op::Positive),
